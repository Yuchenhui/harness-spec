---
name: spec-reviewer
description: "Review the complete OpenSpec change (proposal -> design -> specs -> tasks), assess verifiability, and output a structured review report. Also handles escalation mode — root-cause analysis when a task fails 3 fix attempts."
model: opus
tools:
  - Read(**)
  - Glob(**)
