...
**NOTE: This phase is NOT headless.** It requires a human to answer AskUserQuestion prompts.
For long-running unattended use: pre-create `feature_tests.json` manually, then `/harness:apply`
will detect it and skip directly to Phase 2.
